...
const navMenu = document.getElementById('sidebar'),
    navToggle = document.getElementById('nav-toggle'), // Corrigido: nav__toggle para navToggle
    navClose = document.getElementById('nav-close')    // Corrigido: nav__Close para navClose
...
tabs.forEach(tab => {
    tab.addEventListener("click", () => {
        ...
        tabs.forEach(otherTab => {
            otherTab.classList.remove('skills__active');
        });
...
const modalViews = document.querySelectorAll('.services__modal'),
    modelBtns = document.querySelectorAll('.services__button'),  // Added comma here
...
function navHighlighter() {
    ...
    sections.forEach(current => {
        ...
        /* - if our current scroll position enters the space where current section on screen is, add .active class to correspoding navagation link, else remove it 
